							...
							<?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
								...
								<?php } else {
									...
									if (!filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
										if ($dev->query("INSERT INTO website_requests (name, email, phone_number, address, init_pkg, addon, message, status) VALUES (" . htmlspecialchars_decode("&quot;") . $name . htmlspecialchars_decode("&quot;") . "," . htmlspecialchars_decode("&quot;") . $email . htmlspecialchars_decode("&quot;") . "," . htmlspecialchars_decode("&quot;") . $phone . htmlspecialchars_decode("&quot;") . "," . htmlspecialchars_decode("&quot;") . $address . htmlspecialchars_decode("&quot;") . "," . htmlspecialchars_decode("&quot;") . $init_pkg . htmlspecialchars_decode("&quot;") . "," . htmlspecialchars_decode("&quot;") . $addon . htmlspecialchars_decode("&quot;") . "," . htmlspecialchars_decode("&quot;") . $message . htmlspecialchars_decode("&quot;") . ", 'unread')") == true) {
											?>
											<p style="color:green;">
