					...
					<section id="main">
						...
						<footer>
							<ul class="icons">
								...
								<li><a href="https://www.codewars.com/users/donaldsebleung" title="My Profile on Codewars" target="_blank" class="fa-code">Codewars</a></li>
								...
								<li><a href="https://www.codewars.com/collections/object-oriented-php" title="Train on the 'Object-Oriented PHP' Kata Series on Codewars" target="_blank" class="fa-graduation-cap">"Object-Oriented PHP" Kata Series on Codewars</a></li>
								<li><a href="https://www.codewars.com/collections/php-functions" title="Train on the 'PHP Functions' Kata Series on Codewars" target="_blank" class="fa-graduation-cap">"PHP Functions" Kata Series on Codewars</a></li>
							</ul>
						</footer>
					</section>
