				...
				<!-- Main -->
					<section id="main">
						<header>
							...
							<p><a href="http://codewars.com/users/donaldsebleung" title="donaldsebleung on Codewars" target="_blank"><img src="https://www.codewars.com/users/donaldsebleung/badges/large" style="width: 300px" alt="donaldsebleung on Codewars" /></a></p>
						</header>
						...
						<footer>
							<ul class="icons">
								...
								<li><a href="http://www.codewars.com/r/2QXbZQ" title="Join in the fun by signing up on Codewars and train on your coding skills" target="_blank" class="fa-sign-in">Sign up for an account on Codewars</a></li>
								<li><a href="https://www.codewars.com/collections/php-in-action" title="Train on the 'PHP in Action' Kata Series on Codewars" target="_blank" class="fa-graduation-cap">"PHP in Action" Kata Series on Codewars</a></li>
								<li><a href="https://www.codewars.com/collections/reflection-in-php" title="Train on the 'Reflection in PHP' Kata Series on Codewars" target="_blank" class="fa-graduation-cap">"Reflection in PHP" Kata Series on Codewars</a></li>
								<li><a href="https://www.codewars.com/collections/esolang-interpreters" title="Write your own Esolang Interpreter" target="_blank" class="fa-terminal">"Esolang Interpreters" Kata Series</a></li>
							</ul>
						</footer>
					</section>
