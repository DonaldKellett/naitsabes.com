...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/libs/fontawesome-free-5.0.13/web-fonts-with-css/css/fontawesome-all.css">
						...
						<!-- Contact -->
							<article id="contact">
								...
								<form method="post" action="#">
									...
									<ul class="actions">
										<li><input type="submit" id="submit" value="Send Message" class="special" /></li>
